...
export default function LiveExperience({ profile }) {
  ...
  if (!scenario) return (
    <div style={S.page}>
      <style>{`@import url('https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@400;500;600;700;800&display=swap'); .un-le-layout1{display:grid;grid-template-columns:1fr 280px;gap:24px} @media(max-width:800px){.un-le-layout1{grid-template-columns:1fr!important}}`}</style>
  ...
  return (
    <div style={S.page}>
      <style>{`@import url('https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@400;500;600;700;800&display=swap'); .un-le-layout2{display:grid;grid-template-columns:1fr 240px;gap:20px} @media(max-width:800px){.un-le-layout2{grid-template-columns:1fr!important}}`}</style>
