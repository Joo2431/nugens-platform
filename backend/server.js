...
app.post("/api/mini-chat", requireAuth, async (req, res) => {
  ...
  // ── Per-product identity and scope ──────────────────────────────────────────
...
- Explaining course content, learning paths, and difficulty levels (Beginner / Intermediate / Advanced)
...
- Content creation for new businesses — what assets to prioritise (logo, reel, website)
...
Mention DigiHub for ongoing marketing or HyperX for business skill courses when directly relevant.`,
  ...
  const systemPrompt = [
    ...
    "If asked about cooking, sports, politics, entertainment, relationships, or anything unrelated to",
    "careers, business, professional skills, or Nugens products, respond EXACTLY:",
    `"I'm ${pid.name} — I only help with ${product === "nugens" ? "Nugens products and career/business topics" : `${pid.name.replace(" AI","").replace(" Mini","")} and career topics`}. What can I help you with today?"`,
    "",
    "RESPONSE STYLE:",
    ...
    "- If recommending a product feature, name it specifically (e.g. \"use the HyperX Course Player\", \"open DigiHub Content Planner\")",
  ].join("\n");
