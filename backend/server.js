...
const PLAN_CONFIG = {
  ...
  individual_starter_monthly: { amount: 0,    currency: "INR", label: "Suite Starter Monthly",  durationDays: 30,  profilePlan: "ng_ind_starter" },
  individual_starter_yearly:  { amount: 0,   currency: "INR", label: "Suite Starter Yearly",   durationDays: 365, profilePlan: "ng_ind_starter" },
  individual_premium_monthly: { amount: 9900,   currency: "INR", label: "Suite Premium Monthly",  durationDays: 30,  profilePlan: "ng_ind_premium" },
  individual_premium_yearly:  { amount: 79900,  currency: "INR", label: "Suite Premium Yearly",   durationDays: 365, profilePlan: "ng_ind_premium" },
  individual_pro_monthly:     { amount: 69900,   currency: "INR", label: "Suite Pro Monthly",      durationDays: 30,  profilePlan: "ng_ind_pro"     },
  individual_pro_yearly:      { amount: 499900,  currency: "INR", label: "Suite Pro Yearly",       durationDays: 365, profilePlan: "ng_ind_pro"     },
