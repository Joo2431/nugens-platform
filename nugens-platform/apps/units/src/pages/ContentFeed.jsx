...
export default function ContentFeed({ profile }) {
  ...
  return (
    <div style={{minHeight:"100vh",background:LIGHT,padding:"24px 32px",fontFamily:"'Plus Jakarta Sans',sans-serif"}}>
      <style>{`@import url('https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@400;500;600;700;800&display=swap'); textarea:focus{border-color:${PINK}60!important;outline:none} .un-cf-layout{display:grid;grid-template-columns:1fr 260px;gap:20px;max-width:1100px} @media(max-width:760px){.un-cf-layout{grid-template-columns:1fr!important}}`}</style>

      <div className="un-cf-layout">
        {/* Main */}
        <div>
