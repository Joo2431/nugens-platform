      ...
      <div style={{ marginBottom:28 }}>
        ...
        {loadBrandVoice()?.brandName ? (
          <div style={{marginTop:10,display:"inline-flex",alignItems:"center",gap:7,fontSize:12,fontWeight:600,color:"#16a34a",background:"#16a34a12",border:"1px solid #16a34a30",borderRadius:8,padding:"5px 12px"}}>
            ✓ Using your Brand Voice — {loadBrandVoice().brandName}
          </div>
        ) : (
          <a href="/brand" style={{marginTop:10,display:"inline-flex",alignItems:"center",gap:7,fontSize:12,fontWeight:600,color:MUTED,background:BG,border:"1px solid #e8eaed",borderRadius:8,padding:"5px 12px",textDecoration:"none"}}>
            Set up Brand Voice for on-brand campaigns →
          </a>
        )}
      </div>
          ...
          <div style={{ display:"flex", flexDirection:"column", gap:16 }}>
            ...
            <div>
              ...
              <textarea value={theme} onChange={e=>setTheme(e.target.value)} rows={3}
                ...
                style={{ width:"100%", padding:"10px 13px", background:"#f3f4f6", border:`1.5px solid ${B}`, borderRadius:9, color:TEXT, fontSize:13, fontFamily:"inherit", resize:"vertical", outline:"none", boxSizing:"border-box" }}/>
            </div>
