...
const PRODUCTS = [
  ...
  },
  {
    ...
    desc: "Units is our full-service production studio — photography, videography, and branded content for brands, creators, and individuals. It also serves as the production backbone for HyperX's video learning content and DigiHub's content creation — providing the gear, team, and studio that makes everything visual across Nugens.",
    does: ["Brand & commercial photography/videography", "Events, weddings & corporate productions", "In-house production for HyperX courses", "Content studio for DigiHub's brands", "Podcast, reel, and video production"],
    link: "/units"
  },
];
        ...
        <div style={{ maxWidth: 1060, margin: "0 auto" }}>
          <Reveal style={{ marginBottom: 44 }}>
            ...
            <p style={{ fontSize: 14.5, color: "#6b7280", lineHeight: 1.72, maxWidth: 560, marginTop: 10 }}>
              Each product in Nugens feeds the next. They're not standalone tools — they're a sequence. You start at Gen-E, build at HyperX, connect at DigiHub, and Units powers the production infrastructure behind all of it.
            </p>
          </Reveal>
