...
const PRODUCTS = [
  ...
  { id: "units", title: "Units",  tag: "Production Studio",   desc: "A full-service production house — photography, videography, branded content, and event production for brands, creators, and individuals. The in-house studio powering HyperX's courses and DigiHub's content creation.", features: ["Brand & commercial photography/video", "Events, weddings & corporate productions", "Post-production: films, edits & reels", "Content studio for DigiHub brands"],   color: "#d97706", to: "/units" },
];
...
function FloatCard({ style, children }) {
  return (
    <div aria-hidden="true" style={{
      ...
      pointerEvents: "none", // purely decorative — not clickable, never expect a hover/click state
      userSelect: "none",
      ...style
    }}>
      {children}
      ...
      <section style={{ padding: "72px 24px", background: "#fff", borderBottom: `1px solid ${B}` }}>
        <div className="two-col" style={{ maxWidth: 1060, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "40px 72px", alignItems: "start" }}>
          <Reveal>
            ...
            <Link to="/contact?reason=digihub-brand&intent=discovery" className="btn-pink">Book a discovery call →</Link>
          </Reveal>
          <Reveal delay={100}>
            {[
        ...
        <div style={{ maxWidth: 1060, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(226px,1fr))", gap: 12 }}>
            {[
              ...
              { icon: "◇", t: "Everything is connected",  d: "Gen-E feeds HyperX. HyperX prepares for DigiHub. Units powers production for everyone. One system, not four tools." },
            ].map((c, i) => (
        ...
        <div style={{ maxWidth: 580, margin: "0 auto", textAlign: "center" }}>
          <Reveal>
            ...
            <div style={{ display: "flex", justifyContent: "center", gap: 28, flexWrap: "wrap" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 6 }}>
                <Link to="/contact?reason=general" className="btn-ghost">Talk to us</Link>
                <span style={{ fontSize: 11.5, color: "#9ca3af" }}>Quick questions — general enquiry</span>
              </div>
            </div>
          </Reveal>
        </div>
