      ...
      <div style={{ maxWidth:1200, margin:"0 auto", padding:"52px 24px 44px" }}>
        <div className="ft-grid" style={{ display:"grid", gridTemplateColumns:"1.8fr 1fr 1fr 1fr", gap:"40px 32px", alignItems:"start" }}>
          ...
          <div className="ft-brand">
            ...
            {/* Socials — X, Instagram & YouTube removed: @nugens handles on those
                platforms belong to unrelated third parties, not Nugens. Re-add once
                official accounts are claimed and confirmed. */}
        ...
        <div style={{ maxWidth:1200, margin:"0 auto", padding:"16px 24px",
          ...
          <div style={{ display:"flex", gap:18, flexWrap:"wrap" }}>
            {[
              ...
              { l:"Terms of Use",    h:"/terms-of-use" },
              { l:"Cookie Policy",   h:"/cookie-policy" },
            ].map(item => (
              <Link key={item.l} to={item.h} className="ft-bottom-link">{item.l}</Link>
            ))}
          </div>
        </div>
      </div>
