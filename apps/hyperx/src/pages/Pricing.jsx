...
export default function Pricing({ profile }) {
  ...
  return (
    <div className="p-page" style={S.page}>
      <style>{`@import url('https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@400;500;600;700;800&display=swap');@media(max-width:768px){.p-page{padding:28px 16px!important;}.p-grid{grid-template-columns:1fr!important;max-width:400px!important;}}`}</style>
...
>
      ...
      <div className="p-grid" style={{ display:"grid", gridTemplateColumns:`repeat(${plans.length},1fr)`, gap:16, maxWidth:1100, margin:"0 auto" }}>
        {plans.map(plan => (
