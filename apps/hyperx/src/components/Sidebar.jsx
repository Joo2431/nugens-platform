        ...
        <div style={{ borderTop:`1px solid ${BORDER}`, paddingTop:12 }}>
          {!collapsed ? (
            ...
            <button onClick={signOut}
              style={{ width:42, height:42, background:"none", border:`1px solid ${BORDER}`, borderRadius:10, cursor:"pointer", color:MUTED, fontSize:16, display:"flex", alignItems:"center", justifyContent:"center", margin:"0 auto" }}
              title="Sign out">
              ←
            </button>
          )}
