          ...
          <div style={{ ...S.card, marginBottom:20 }}>
            <div style={{ display:"flex", gap:12, marginBottom:12 }}>
              ...
              <textarea
                ...
                style={{ flex:1, background:"#f3f4f6", border:`1px solid ${B}`, borderRadius:10, padding:12, color:"#ccc", fontSize:13, fontFamily:"inherit", resize:"none", minHeight:80, outline:"none" }}
              />
            </div>
            <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center" }}>
              <select value={postType} onChange={e=>setPostType(e.target.value)} style={{ background:"#f3f4f6", border:`1px solid ${B}`, borderRadius:7, padding:"6px 10px", color:"#ccc", fontSize:12, fontFamily:"inherit", outline:"none" }}>
