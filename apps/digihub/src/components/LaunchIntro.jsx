  ...
  return (
    <div style={{
      ...
      <div style={{ position:"relative", width:72, height:72, display:"flex", alignItems:"center", justifyContent:"center" }}>
        <div style={{ position:"absolute", inset:0, borderRadius:20, border:`2px solid ${BLUE}`, animation:"li-ring 1.1s ease-out infinite" }} />
        <div style={{
          width:64, height:64, borderRadius:18,
          background:`linear-gradient(135deg,${BLUE},${PINK})`,
          display:"flex", alignItems:"center", justifyContent:"center",
          fontWeight:900, fontSize:21, color:"#fff", letterSpacing:"-0.03em",
          boxShadow:`0 14px 38px ${BLUE}45`,
