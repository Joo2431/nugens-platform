  ...
  return (
    <div style={{
      ...
      <div style={{ display:"flex", alignItems:"center", gap:10, flexShrink:0 }}>
        {/* BUG FIX: this was <a href="https://nugens.in/dashboard">, an
  ...
  <div class="page">
    <div class="header">
      <div>
        ...
        <div class="header-sub">AI Career Intelligence · nugens.in</div>
      </div>
      <div class="header-date">AI-Generated Resume<br/>${date}</div>
    </div>
    <div class="content">${html}</div>
    <div class="footer">Generated by Gen-E AI · nugens.in · This resume was created with AI assistance</div>
  </div>
  <script>
