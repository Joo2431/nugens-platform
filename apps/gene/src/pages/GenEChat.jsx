...
<head>
  <meta charset="UTF-8"/>
  <title>${profile?.full_name ? profile.full_name + " — Resume" : "Resume"}</title>
  <!-- Hidden provenance watermark: not rendered, not printed, invisible to
       recruiters/ATS parsers. Present in page source only. -->
  <meta name="generator" content="Gen-E AI — Nugens (gene.nugens.in)"/>
  <meta name="author" content="Generated via Gen-E AI"/>
  <meta name="gene-export-date" content="${date}"/>
  <style>
    @import url('https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&display=swap');
    * { box-sizing: border-box; margin: 0; padding: 0; }
    body { font-family: 'Inter', Arial, sans-serif; background: #fff; color: #111; }
    .page { width: 794px; min-height: 1123px; margin: 0 auto; padding: 40px 44px; }
    @media print {
