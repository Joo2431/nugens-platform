...
const TOOLS = [
  { to:"/business/jd",        icon:"▤", label:"JD Generator",      desc:"Generate job descriptions + interview questions",   color:"#7c3aed", badge:"Most used" },
  { to:"/business/hiring",    icon:"◎", label:"Hiring Intelligence",desc:"Skills, salary, strategy for any role you're hiring",color:PINK,      badge:null },
  { to:"/business/team",      icon:"◈", label:"Team Skill Map",     desc:"Upload team data, find skill gaps and training needs",color:"#0284c7", badge:"Premium" },
  { to:"/business/workforce", icon:"⬡", label:"Workforce Planner",  desc:"Hiring roadmap based on your company stage and goals",color:"#d97706", badge:null },
  { to:"/business/salary",    icon:"₹", label:"Salary Benchmark",   desc:"Real salary data for any role in the Indian market",  color:"#16a34a", badge:null },
  { to:"/business/interview", icon:"◷", label:"Interview AI",       desc:"Generate role-specific interview questions + rubric",  color:"#0284c7", badge:null },
];
