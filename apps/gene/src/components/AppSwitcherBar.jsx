  ...
  return (
    <>
      <style>{`
        ...
        /* Shared pill style — desktop and mobile use the same class */
        .asb-pill {
          display: flex;
          align-items: center;
          gap: 4px;
        ...
        /* Mobile dropdown — same pill row as desktop, just wraps below the bar */
        .asb-mobile-menu {
          position: fixed;
          top: 44px;
          left: 0;
      ...
      <div style={{
        ...
        <div className="asb-desktop-apps" style={{ display:"flex", alignItems:"center", gap:3, position:"absolute", left:"50%", transform:"translateX(-50%)" }}>
          {APPS.map(app => (
            ...
            >
              ...
              {app.label}
              {app.active && <span style={{ width:5, height:5, borderRadius:"50%", background:app.color, display:"inline-block", flexShrink:0 }}/>}
            </a>
          ))}
        </div>
        ...
        <div style={{ display:"flex", alignItems:"center", gap:8, flexShrink:0 }}>
          ...
          <button
            ...
            style={{ display:"none", alignItems:"center", justifyContent:"center", width:32, height:32, background:"none", border:"1px solid #e8eaed", borderRadius:7, cursor:"pointer", color:"#6b7280", fontSize:15 }}
          >
            {menuOpen ? "✕" : "⊞"}
          </button>
        </div>
